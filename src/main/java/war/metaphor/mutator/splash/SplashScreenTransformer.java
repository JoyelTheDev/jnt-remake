...
public class SplashScreenTransformer extends Mutator {
    public SplashScreenTransformer(ObfuscatorContext base, ConfigurationSection config) {
        super(base, config);
    }
    ...
    public void run(ObfuscatorContext base) {
        ...
        try (InputStream ssResource = IntegrateLoaderTransformer.class.getResourceAsStream("/war/toolkit/SplashScreen.class")) {
            if (ssResource == null)
